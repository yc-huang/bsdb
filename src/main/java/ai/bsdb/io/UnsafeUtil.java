...
/**
 * Helper methods for using sun.misc.Unsafe. Copied from https://github.com/xerial/larray/blob/master/larray-buffer/src/main/java/xerial/larray/buffer/UnsafeUtil.java
 *
 * @author Taro L. Saito
 */
