...
/**
 * modified to make offer method blocking, which is suitable to use as ExecutorService's task queue.
 *
 ...
 */
public final class DisruptorBlockingQueueModified<E> extends MultithreadConcurrentQueue<E> implements Serializable, Iterable<E>, Collection<E>, BlockingQueue<E>, Queue<E> {
