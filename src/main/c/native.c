...
#include <string.h>
#include "liburing.h"
#include "ai_bsdb_io_Native.h"
#include "ai_bsdb_io_Native_Uring.h"
...
JNIEXPORT void JNICALL Java_ai_bsdb_io_Native_00024Uring_initIDs(JNIEnv * env, jclass clz)
{
    ring_fid = (*env)->GetFieldID(env, clz, "_ring", "J");
    io_uring_probe_p = (jlong)io_uring_get_probe();
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_initUring(JNIEnv * env, jobject self, jint entries, jlong flags)
{
...
JNIEXPORT void JNICALL Java_ai_bsdb_io_Native_00024Uring_exitUring(JNIEnv * env, jobject self)
{
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_registerBuffers(JNIEnv * env, jobject self, jlongArray buffers, jlongArray lens)
{
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_unregisterBuffers(JNIEnv * env, jobject self)
{
    return io_uring_unregister_buffers(GET_RING(env, self));
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_registerFiles(JNIEnv * env, jobject self, jintArray fds)
{
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_unregisterFiles(JNIEnv * env, jobject self)
{
    return io_uring_unregister_files(GET_RING(env, self));
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareReadM(JNIEnv * env, jobject self, jlongArray reqIds, jlong flags, jint fd, jlongArray buffers, jintArray lens, jlongArray offsets, jint from, jint to)
{
	...
	for(int i = from; i <= to; i++){
		jint ret = Java_ai_bsdb_io_Native_00024Uring_prepareRead(env, self, reqId_ptr[i], flags, fd, buffer_ptr[i], len_ptr[i], offset_ptr[i]);
		if(ret < 0) break; else cnt++;
	}
	return cnt;
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareRead(JNIEnv * env, jobject self, jlong reqId, jlong flags, jint fd, jlong bufptr, jint len, jlong offset)
{
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareReads(JNIEnv * env, jobject self, jlong reqId, jlong flags, jint fd, jlongArray bufptrs, jintArray lens, jlong offset)
{
    GET_SQE(env, self, flags);
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareReadFixed(JNIEnv * env, jobject self, jlong reqId, jlong flags, jint fd, jlong bufptr, jint len, jlong offset, jint bufIndex)
{
    GET_SQE(env, self, flags);
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareWrite(JNIEnv * env, jobject self, jlong reqId, jlong flags, jint fd, jlong bufptr, jint len, jlong offset)
{
    GET_SQE(env, self, flags);
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareWrites(JNIEnv * env, jobject self, jlong reqId, jlong flags, jint fd, jlongArray bufptr, jintArray len, jlong offset)
{
    GET_SQE(env, self, flags);
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareWriteFixed(JNIEnv * env, jobject self, jlong reqId, jlong flags, jint fd, jlong bufptr, jint len, jlong offset, jint bufIndex)
{
    GET_SQE(env, self, flags);
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_prepareFsync(JNIEnv * env, jobject self, jlong reqId, jlong flags, jint fd, jlong fsyncFlags)
{
    GET_SQE(env, self, flags);
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_submit(JNIEnv * env, jobject self)
{
    return io_uring_submit(GET_RING(env, self));
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_submitAndWait(JNIEnv * env, jobject self, jint n)
{
    return io_uring_submit_and_wait(GET_RING(env, self), n);
}


JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_waitCQEntryTimeout(JNIEnv * env, jobject self, jlongArray reqIds, jlongArray retCodes, long ms)
{
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_waitCQEntries(JNIEnv * env, jobject self, jlongArray reqIds, jlongArray retCodes, jint n)
{
    struct io_uring_cqe * cqe_ptr;
...
JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_availableSQ(JNIEnv * env, jobject self)
{
    return io_uring_sq_space_left(GET_RING(env, self));
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_00024Uring_peekCQEntries(JNIEnv * env, jobject self, jlongArray reqIds, jlongArray retCodes, jint n)
{
...
JNIEXPORT void JNICALL Java_ai_bsdb_io_Native_00024Uring_advanceCQ(JNIEnv * env, jobject self, jint n)
{
    struct io_uring * ring = GET_RING(env, self);
    io_uring_cq_advance(ring, n);
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_open(JNIEnv * env, jclass self, jstring fileName, jint flags)
{
...
JNIEXPORT jlong JNICALL Java_ai_bsdb_io_Native_allocateAligned(JNIEnv * env, jclass self, jint size, jint align){
	void *buf;
...
JNIEXPORT void JNICALL Java_ai_bsdb_io_Native_free(JNIEnv * env, jclass self, jlong address){
	free((void *)address);
}

JNIEXPORT jlong JNICALL Java_ai_bsdb_io_Native_pread(JNIEnv * env, jclass self, jint fd, jlong position, jlong bufPtr, jint size){
	return pread((int)fd, (void*) bufPtr, (unsigned) size, (off_t)position);
}

JNIEXPORT jint JNICALL Java_ai_bsdb_io_Native_close(JNIEnv * env, jclass cls, jint fd){
	return close((int)fd);
}
